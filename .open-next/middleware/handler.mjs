...
var NextConfig = {
  ...
  outputFileTracingRoot: '/Users/mhousni/Documents/fiverr/leadhero/datocms-test',
  ...
  turbopack: { root: '/Users/mhousni/Documents/fiverr/leadhero/datocms-test' },
  distDirRoot: '.next',
};
...
var RoutesManifest = {
  ...
  routes: {
    static: [
      ...
      {
        page: '/api/draft-mode/disable',
        regex: '^/api/draft\\-mode/disable(?:/)?$',
        routeKeys: {},
        namedRegex: '^/api/draft\\-mode/disable(?:/)?$',
      },
      {
        page: '/api/draft-mode/enable',
        regex: '^/api/draft\\-mode/enable(?:/)?$',
        routeKeys: {},
        namedRegex: '^/api/draft\\-mode/enable(?:/)?$',
      },
      {
        page: '/api/invalidate-cache',
        regex: '^/api/invalidate\\-cache(?:/)?$',
        routeKeys: {},
        namedRegex: '^/api/invalidate\\-cache(?:/)?$',
      },
      {
        page: '/api/post-deploy',
        regex: '^/api/post\\-deploy(?:/)?$',
        routeKeys: {},
        namedRegex: '^/api/post\\-deploy(?:/)?$',
      },
      {
        page: '/api/preview-links',
        regex: '^/api/preview\\-links(?:/)?$',
        routeKeys: {},
        namedRegex: '^/api/preview\\-links(?:/)?$',
      },
      {
        page: '/api/seo-analysis',
        regex: '^/api/seo\\-analysis(?:/)?$',
        routeKeys: {},
        namedRegex: '^/api/seo\\-analysis(?:/)?$',
      },
      { page: '/basic', regex: '^/basic(?:/)?$', routeKeys: {}, namedRegex: '^/basic(?:/)?$' },
      {
        page: '/private-datocms-plugin',
        regex: '^/private\\-datocms\\-plugin(?:/)?$',
        routeKeys: {},
        namedRegex: '^/private\\-datocms\\-plugin(?:/)?$',
      },
      {
        page: '/real-time-updates',
        regex: '^/real\\-time\\-updates(?:/)?$',
        routeKeys: {},
        namedRegex: '^/real\\-time\\-updates(?:/)?$',
      },
    ],
    dynamic: [
      {
        page: '/basic/page/[slug]',
        regex: '^/basic/page/([^/]+?)(?:/)?$',
        routeKeys: { nxtPslug: 'nxtPslug' },
        namedRegex: '^/basic/page/(?<nxtPslug>[^/]+?)(?:/)?$',
      },
      {
        page: '/real-time-updates/[slug]',
        regex: '^/real\\-time\\-updates/([^/]+?)(?:/)?$',
        routeKeys: { nxtPslug: 'nxtPslug' },
        namedRegex: '^/real\\-time\\-updates/(?<nxtPslug>[^/]+?)(?:/)?$',
      },
    ],
    data: { static: [], dynamic: [] },
  },
...
var PrerenderManifest = {
  ...
  routes: {
    ...
    '/private-datocms-plugin': {
      experimentalBypassFor: [
        { type: 'header', key: 'next-action' },
        { type: 'header', key: 'content-type', value: 'multipart/form-data;.*' },
      ],
      initialRevalidateSeconds: false,
      srcRoute: '/private-datocms-plugin',
      dataRoute: '/private-datocms-plugin.rsc',
      allowHeader: [
        'host',
        'x-matched-path',
        'x-prerender-revalidate',
    ...
    '/real-time-updates': {
      ...
      initialRevalidateSeconds: false,
      srcRoute: '/real-time-updates',
      dataRoute: '/real-time-updates.rsc',
      allowHeader: [
        'host',
        'x-matched-path',
        'x-prerender-revalidate',
  ...
  notFoundRoutes: [],
  preview: {
    previewModeId: '061797531684fbb8bded046f3bae017e',
    previewModeSigningKey: '1ea6dfe22e82cf1b43f953f04daa2c793368c824e6b2179b6e4f37f2fd8e4754',
...
var AppPathRoutesManifest = {
  '/(base-layout)/basic/page': '/basic',
  '/(base-layout)/basic/page/[slug]/page': '/basic/page/[slug]',
  '/(base-layout)/page': '/',
  '/(base-layout)/real-time-updates/[slug]/page': '/real-time-updates/[slug]',
  '/(base-layout)/real-time-updates/page': '/real-time-updates',
  '/_global-error/page': '/_global-error',
  '/_not-found/page': '/_not-found',
  '/api/draft-mode/disable/route': '/api/draft-mode/disable',
  '/api/draft-mode/enable/route': '/api/draft-mode/enable',
  '/api/invalidate-cache/route': '/api/invalidate-cache',
  '/api/post-deploy/route': '/api/post-deploy',
  '/api/preview-links/route': '/api/preview-links',
  '/api/seo-analysis/route': '/api/seo-analysis',
  '/private-datocms-plugin/page': '/private-datocms-plugin',
};
